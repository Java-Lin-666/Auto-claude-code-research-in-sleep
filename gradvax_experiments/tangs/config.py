...
ORACLE_METHODS = {"oracle-fixmatch", "oracle-tangs"}
...
def build_run_config(args: Any) -> RunConfig:
    ...
    if args.amp:
        raise ValueError("AMP is forbidden by protocol v4.5; geometry and training are FP32.")
    ...
    if args.mode == "development" and args.protocol != "P-C10-100":
        raise ValueError("Development tuning is locked to P-C10-100.")
