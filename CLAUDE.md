...
ARIS (Auto-claude-code-research-in-sleep) is a **skill-based research harness** — a collection of plain Markdown `SKILL.md` files that orchestrate the ML research lifecycle. There is no build system, no compiled code, and no runtime dependencies. The "code" is Markdown skills invoked via Claude Code slash commands.
...
- **Executor** (Claude): writes code, runs experiments, drafts papers
